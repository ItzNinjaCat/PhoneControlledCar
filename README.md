...
*Проекът представлява количка, която се управлява от компютър, свързан с нея, чрез интернет. За улесняване на управлението на количката, потребителят получава видео на живо и информация от ултразавуков сензор за разстояние.*
