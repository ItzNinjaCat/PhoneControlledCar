...
1) Свалетe `.apk` файлът, чрез който се инсталира приложението за Android от [тук]().
...
1) Отворете `.apk` файлът, който свалихте. Докато се инсталира може да се появят предупреждения, че във файла може да има вируси и трябва да натиснете на бутона за инсталиране въпреки опасността.
